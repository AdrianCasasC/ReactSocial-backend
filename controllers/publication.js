...
const remove = (req, res) => {
    ...
    Publication.findOneAndDelete({ user: req.user.id, _id: publicationId }, (error, deletedPublication) => {
        if (error || !deletedPublication) {
        ...
        const filePath = "./uploads/publications/" + deletedPublication.file;
